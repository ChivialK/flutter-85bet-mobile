...
/// @version 2020/6/19
///
class HomeSimpleShortcutWidget extends StatefulWidget {
  final HomeDisplaySizeCalc sizeCalc;
  final EventStore eventStore;

  HomeSimpleShortcutWidget({
    Key key,
  ...
  @override
  HomeSimpleShortcutWidgetState createState() =>
      HomeSimpleShortcutWidgetState();
}

class HomeSimpleShortcutWidgetState extends State<HomeSimpleShortcutWidget> {
