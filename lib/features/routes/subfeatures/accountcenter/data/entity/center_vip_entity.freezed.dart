...
part of 'center_vip_entity.dart';
...
abstract class $CenterVipEntityCopyWith<$Res> {
  factory $CenterVipEntityCopyWith(
      ...
      _$CenterVipEntityCopyWithImpl<$Res>;
  $Res call(
      {dynamic vipOption,
      dynamic vipSetting,
      num allGame,
...
class _$CenterVipEntityCopyWithImpl<$Res>
  ...
  final CenterVipEntity _value;
  // ignore: unused_field
  final $Res Function(CenterVipEntity) _then;
...
abstract class _$CenterVipEntityCopyWith<$Res>
  ...
  factory _$CenterVipEntityCopyWith(
          _CenterVipEntity value, $Res Function(_CenterVipEntity) then) =
      __$CenterVipEntityCopyWithImpl<$Res>;
  @override
  $Res call(
      {dynamic vipOption,
      dynamic vipSetting,
...
class __$CenterVipEntityCopyWithImpl<$Res>
  ...
  __$CenterVipEntityCopyWithImpl(
      _CenterVipEntity _value, $Res Function(_CenterVipEntity) _then)
      : super(_value, (v) => _then(v as _CenterVipEntity));

  @override
  _CenterVipEntity get _value => super._value as _CenterVipEntity;
...
class _$_CenterVipEntity implements _CenterVipEntity {
  const _$_CenterVipEntity(
      ...
      this.cardGameValue,
      this.casinoGame,
      this.casinoGameLevel,
      this.casinoGameValue,
      this.fishGame,
      this.fishGameLevel,
      this.fishGameValue,
      this.lotteryGame,
      this.lotteryGameLevel,
      this.lotteryGameValue,
      this.slotGame,
      this.slotGameLevel,
      this.slotGameValue,
      this.sportGame,
  ...
  @override
  String toString() {
    return 'CenterVipEntity(vipOption: $vipOption, vipSetting: $vipSetting, allGame: $allGame, allGameLevel: $allGameLevel, allGameValue: $allGameValue, cardGame: $cardGame, cardGameLevel: $cardGameLevel, cardGameValue: $cardGameValue, casinoGame: $casinoGame, casinoGameLevel: $casinoGameLevel, casinoGameValue: $casinoGameValue, fishGame: $fishGame, fishGameLevel: $fishGameLevel, fishGameValue: $fishGameValue, lotteryGame: $lotteryGame, lotteryGameLevel: $lotteryGameLevel, lotteryGameValue: $lotteryGameValue, slotGame: $slotGame, slotGameLevel: $slotGameLevel, slotGameValue: $slotGameValue, sportGame: $sportGame, sportGameLevel: $sportGameLevel, sportGameValue: $sportGameValue)';
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _CenterVipEntity &&
            (identical(other.vipOption, vipOption) ||
                const DeepCollectionEquality()
                    .equals(other.vipOption, vipOption)) &&
            (identical(other.vipSetting, vipSetting) ||
                const DeepCollectionEquality()
                    .equals(other.vipSetting, vipSetting)) &&
            ...
            (identical(other.lotteryGameLevel, lotteryGameLevel) ||
                const DeepCollectionEquality()
                    .equals(other.lotteryGameLevel, lotteryGameLevel)) &&
            (identical(other.lotteryGameValue, lotteryGameValue) ||
                const DeepCollectionEquality()
                    .equals(other.lotteryGameValue, lotteryGameValue)) &&
            (identical(other.slotGame, slotGame) ||
                const DeepCollectionEquality()
                    .equals(other.slotGame, slotGame)) &&
            (identical(other.slotGameLevel, slotGameLevel) ||
                const DeepCollectionEquality()
                    .equals(other.slotGameLevel, slotGameLevel)) &&
            (identical(other.slotGameValue, slotGameValue) ||
                const DeepCollectionEquality()
                    .equals(other.slotGameValue, slotGameValue)) &&
            (identical(other.sportGame, sportGame) ||
                const DeepCollectionEquality()
                    .equals(other.sportGame, sportGame)) &&
            (identical(other.sportGameLevel, sportGameLevel) ||
                const DeepCollectionEquality().equals(other.sportGameLevel, sportGameLevel)) &&
...
abstract class _CenterVipEntity implements CenterVipEntity {
  const factory _CenterVipEntity(
      ...
      num sportGame,
      int sportGameLevel,
      num sportGameValue}) = _$_CenterVipEntity;
