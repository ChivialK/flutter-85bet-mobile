...
mixin _$RollerStore on _RollerStore, Store {
  ...
  final _$getWinnersListAsyncAction =
      AsyncAction('_RollerStore.getWinnersList');

  @override
  Future<void> getWinnersList() {
    return _$getWinnersListAsyncAction.run(() => super.getWinnersList());
  }
