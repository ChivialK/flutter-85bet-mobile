...
class _$_AdModel implements _AdModel {
  const _$_AdModel(
      ...
      this.pic,
      this.url,
      @JsonKey(name: 'mobile_url') this.mobileUrl,
      @JsonKey(name: 'pic_mobile') this.picMobile,
      @JsonKey(name: 'start_time') this.startTime,
      @JsonKey(name: 'end_time') this.endTime,
      this.sort,
      this.status,
      @JsonKey(name: 'url_blank') this.urlBlank});
  ...
  @override
  String toString() {
    return 'AdModel(id: $id, title: $title, type: $type, pic: $pic, url: $url, mobileUrl: $mobileUrl, picMobile: $picMobile, startTime: $startTime, endTime: $endTime, sort: $sort, status: $status, urlBlank: $urlBlank)';
  }
...
abstract class _AdModel implements AdModel {
  const factory _AdModel(
      ...
      int sort,
      bool status,
      @JsonKey(name: 'url_blank') bool urlBlank}) = _$_AdModel;
