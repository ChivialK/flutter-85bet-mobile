...
///
/// Copy from ConfigurableExpansionTile and adjust header gesture detector
/// origin: https://pub.dev/packages/configurable_expansion_tile
///
/// See:
/// [ExpansionTile]
///
...
class CustomizeExpansionTileState extends State<CustomizeExpansionTile>
  ...
  void initState() {
    ...
    _heightFactor = _controller.drive(CustomizeExpansionTile._easeInTween);
    _iconTurns = _controller.drive((widget.animatedWidgetTurnTween ??
            CustomizeExpansionTile._halfTween)
        .chain(
            widget.animatedWidgetTween ?? CustomizeExpansionTile._easeInTween));

    _borderColor = _controller.drive(_borderColorTween.chain(
        widget.borderAnimationTween ?? CustomizeExpansionTile._easeOutTween));
    _borderColorTween.end = widget.borderColorEnd;

    _headerColor = _controller.drive(_headerColorTween.chain(
        widget.headerAnimationTween ?? CustomizeExpansionTile._easeInTween));
