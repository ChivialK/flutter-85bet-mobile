...
///
/// Origin From: https://pub.dev/packages/table_sticky_headers
/// Version: 1.1.2
///
class TableFixedWidget extends StatefulWidget {
  TableFixedWidget({
    Key key,
  ...
  @override
  _TableFixedWidgetState createState() => _TableFixedWidgetState();
}

class _TableFixedWidgetState extends State<TableFixedWidget> {
            ...
            children: <Widget>[
              ...
              Expanded(
                child: NotificationListener<ScrollNotification>(
                  ...
                  child: CustomizedScrollWithScrollbar(
